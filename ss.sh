...
tgid="1675925866"  # ID чата для автобэкапа (Необходим доступ к сообщениям)
tg2id="1675925866" # ID чата диллерской группы для отправки ключей
admls="2097194970"	   # ID Админа
bot_api="5149332679:AAEVz0oe6gNP4mIiB65ykr4s6XlfU9VPuvw" # Токен бота 
